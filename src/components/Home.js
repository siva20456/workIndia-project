...
const Home = () => {
    ...
    const [state, setState] = useState({ url: 'https://api.themoviedb.org/3/movie/popular?api_key=f110d6b8f8fcdc0c3f58df95c3f92a5b&language=en-US', page: 1 })
    ...
    const Search = (url) => {
        ...
        if (url !== '') {
            ...
            setState({url:'https://api.themoviedb.org/3/movie/popular?api_key=f110d6b8f8fcdc0c3f58df95c3f92a5b&language=en-US',page:1})
        }
    }
    ...
    return (
        <div className='home-container'>
            <Header Search={Search} current='home' />
